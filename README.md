...
4.	To evaluate product and vendor performance based on sales volume and revenue contribution.
...
4.	Analyze time-based trends such as monthly and yearly sales variations
